...
import { Trophy, TrendingUp, Users, Award, Maximize2, Minimize2, Crown } from 'lucide-react';
...
const AgentPointsDashboardPage: React.FC = () => {
  ...
  return (
    <div className={`space-y-6 ${isFullscreen ? 'fixed inset-0 z-50 bg-white dark:bg-gray-900 p-6 overflow-auto shadow-2xl' : ''}`}>
      {/* Header */}
